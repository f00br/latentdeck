"""Machine-readable LD-Q4 descriptor access without mutable shared state."""
...
def get_descriptor() -> dict[str, Any]:
    """Return a defensive copy of the trusted Q4 descriptor."""

    return deepcopy(_DESCRIPTOR)


def get_descriptor_schema() -> dict[str, Any]:
    """Return a defensive copy of the Q4 descriptor JSON Schema."""
