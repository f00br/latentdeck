...
pub use lifecycle::{
    ...
    enable_if_only_installed_version, install, install_from_bundled_index, inventory, list, remove,
    repair, repair_from_bundled_index, resolve_active, resolve_installed, verify,
};
pub use model::*;
